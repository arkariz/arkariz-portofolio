...
class ContactScreenWeb extends GetView<ContactScreenController> {
  const ContactScreenWeb({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      spacing: 20.h,
      children: [
        CustomText(text: "Let's Work Together", fontSize: 80.sp, fontWeight: FontWeight.bold),
        CustomText(
