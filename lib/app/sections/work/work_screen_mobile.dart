...
class WorkScreenMobile extends GetView<WorkScreenController> {
  WorkScreenMobile({super.key});

  final iconConstraints = BoxConstraints(maxWidth: 50);
  final double carouselHeight = 550;
  final double cardWidth = 300;
  final double verticalSpacing = 20.h;
  final double cardSpacing = 70;
  ...
  Widget renderServiceCard(BoxConstraints constraints) {
    return Row(
      ...
      children: [
        ...
        ConstrainedBox(
          constraints: BoxConstraints(
            maxWidth: constraints.maxWidth - iconConstraints.maxWidth * 2,
